...
public class ThongKeThangSau extends Fragment {
    int mPage;
    String mTittle;
    int count=0;
    ...
    public ThongKeThangSau() {
    }

    public static ThongKeThangSau newInstance(int page, String tittle) {
        ThongKeThangSau thongKeThangSau = new ThongKeThangSau();
        Bundle bundle = new Bundle();
        bundle.putString("page", tittle);
        bundle.putInt("tittle", page);
        thongKeThangSau.setArguments(bundle);
        return thongKeThangSau;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.tk_thang_sau, container, false);
        context = getActivity();
...
//        Log.d("thangsau", "addData:itemlist " + itemsList.length);
        for (int i = 0; i < count; i++) {
            yVals1.add(new Entry(numList[i], i));
        }
//        Log.d("thangsau", "addData: " + yVals1.size());
        ArrayList<String> xVals = new ArrayList<String>();

        for (int i = 0; i < count; i++) {
            xVals.add(itemsList[i]);
        }
//        Log.d("thangsau", "addData: xVAls " + xVals.size());
